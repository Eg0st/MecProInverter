...
uint8_t TLA2528::StartUp_TLA2528(TwoWire* wire) {
  ...
  delay(500);
  if(!error_write) error_write+=(0x02&single_read_to_reg(wire,TLA2528_GENERAL_CFG)) ? 1 : 0; //gegencheck, ob eine 0x02 zu lesen ist (0 und 1 vertauscht)
  return error_write;
}
...
int Auslesereihenfolge(TwoWire*wire,uint8_t flag)
{
  ...
  if(flag)
  {
    ...
    {
      case 1:
        error_flag=V_TANK_CALC*TLA2528::man_CHA_Read(wire,V_TANK);
        error_flag=V_15_CALC*TLA2528::man_CHA_Read(wire,V_15);
      case 2:
        error_flag=V_TANK_CALC*TLA2528::man_CHA_Read(wire,V_TANK);
        error_flag=V_3_3_CALC*TLA2528::man_CHA_Read(wire,V_3_3);
      case 3:
        error_flag=V_TANK_CALC*TLA2528::man_CHA_Read(wire,V_TANK);
        error_flag=V_3_3_CALC*TLA2528::man_CHA_Read(wire,V_3_3);
      case 4:

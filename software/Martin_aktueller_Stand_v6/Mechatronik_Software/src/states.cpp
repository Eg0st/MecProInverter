...
{  
  ...
  while(V_TANK_VOLTAGE_THRES>=V_TANK_CALC*TLA2528::man_CHA_Read(interface->twoWire,V_TANK))
  {
    //Timeout
    if ((millis()-last_timestamp)>=10000)
    {
  ...
  Serial.println("State_Pre_Charge");
}
